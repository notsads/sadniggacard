...
//const { sadniggacard } = require("..");
 ...
 canvas.GlobalFonts.registerFromPath(`node_modules/sadniggacard/ajju/st/font/KaushanScript-Regular.ttf`, "mayank");
 canvas.GlobalFonts.registerFromPath(`node_modules/sadniggacard/ajju/st/font/circularstd-black.otf`, "circular-std");
 canvas.GlobalFonts.registerFromPath(`node_modules/sadniggacard/ajju/st/font/notosans-jp-black.ttf`, "noto-sans-jp");
 canvas.GlobalFonts.registerFromPath(`node_modules/sadniggacard/ajju/st/font/notosans-black.ttf`, "noto-sans");
 canvas.GlobalFonts.registerFromPath(`node_modules/sadniggacard/ajju/st/font/notoemoji-bold.ttf`, "noto-emoji");
 canvas.GlobalFonts.registerFromPath(`node_modules/sadniggacard/ajju/st/font/notosans-kr-black.ttf`, "noto-sans-kr");
 canvas.GlobalFonts.registerFromPath(`node_modules/sadniggacard/ajju/st/font/Chewy-Regular.ttf`, "chewy");
 canvas.GlobalFonts.registerFromPath(`node_modules/sadniggacard/ajju/st/font/CaveatBrush-Regular.ttf`, "ravyy");
 canvas.GlobalFonts.registerFromPath(`node_modules/sadniggacard/ajju/st/font/Satisfy-Regular.ttf`, "sneha");
 canvas.GlobalFonts.registerFromPath(`node_modules/sadniggacard/ajju/st/font/Space.ttf`, "space");
 canvas.GlobalFonts.registerFromPath(`node_modules/sadniggacard/ajju/st/font/AkayaTelivigala-Regular.ttf`, "spacex");
 canvas.GlobalFonts.registerFromPath(`node_modules/sadniggacard/ajju/st/font/BerkshireSwash-Regular.ttf`, "ariana");
...
class sadniggacard {
    ...
    async build() {
        ...
        if (this.theme == 'classic') {
            ...
            const background = await canvas.loadImage(`https://i.imgur.com/lGE8Of8.png`);
            ...
            const bg2 = await canvas.loadImage("https://i.imgur.com/zvh0jma.png")
           ...
           ctx.drawImage(thumbnailCanvas, 70, 50, 350, 350);
            ...
            const background = await canvas.loadImage(`https://i.imgur.com/c4LzPWm.png`);
           ...
           ctx.drawImage(thumbnailCanvas, 70, 50, 350, 350);
            ...
            const background = await canvas.loadImage(`https://i.imgur.com/6tsp9vy.jpg`);
           ...
           ctx.drawImage(thumbnailCanvas, 70, 50, 350, 350);
            ...
            const background = await canvas.loadImage(`https://i.imgur.com/8yNGYj5.png`);
           ...
           ctx.drawImage(thumbnailCanvas, 70, 50, 350, 350);
            ...
            const background = await canvas.loadImage(`https://i.imgur.com/jBQmQJn.jpg`);
